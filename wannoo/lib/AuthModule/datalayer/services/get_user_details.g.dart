...
class _UserDetailsRemote implements UserDetailsRemote {
  _UserDetailsRemote(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<UserDetail> getUserDetails({required String uid}) async {
